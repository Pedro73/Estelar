...
i=0.001
P1,p1,m1,r1 = stellar_structure(1.5,i)
P2,p2,m2,r2 = stellar_structure(1.33334,i)
P3,p3,m3,r3 = stellar_structure(1.666667,i)
P4,p4,m4,r4 = stellar_structure(3.3,inc)


r_sol, p_sol = np.loadtxt("sol.dat",usecols=(0,3),unpack=True)
plt.figure()
plt.plot(r4,p4,linestyle='-',color="r",label=r"$n = 3.3$")
...
plt.title("Intervalos $\Delta r$ = 0.001")
plt.legend()
plt.show()